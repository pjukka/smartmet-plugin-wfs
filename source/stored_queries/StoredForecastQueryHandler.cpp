...
bw::StoredForecastQueryHandler::StoredForecastQueryHandler(
    ...
    : SupportsExtraHandlerParams(config, false),
      ...
      ind_lat(SmartMet::add_param(common_params, "latitude", Parameter::Type::DataDerived)),
      ind_lon(SmartMet::add_param(common_params, "longitude", Parameter::Type::DataDerived)),
